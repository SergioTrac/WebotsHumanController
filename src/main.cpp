...
/** \mainpage RoboComp::WebotsHumanController
 *
 * \section intro_sec Introduction
 *
 * The WebotsHumanController component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/WebotsHumanController --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class WebotsHumanController : public RoboComp::Application
{
public:
	WebotsHumanController (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::WebotsHumanController::initialize()
{
...
int ::WebotsHumanController::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::WebotsHumanController app(prefix, startup_check_flag);
